  ...
  return (
    <div className='bg-black'> 
      <motion.footer
        ...
        className="relative  border-0 rounded-t-[40px] md:rounded-t-[64px]  bg-linear-to-br from-purple-600 via-purple-500 to-purple-700 px-8 py-16 md:px-16 lg:px-24"
      >
